...
import { LayoutDashboard, ListTodo, CheckCircle2, Rss, AlertTriangle, ExternalLink, RefreshCw, ShoppingBag, Heart, MessageSquare, Users, Mail, Wallet, CreditCard, Gauge, Sunrise, Menu, X, CloudLightning, Waypoints, Archive, Search, PartyPopper } from "lucide-react";
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: "/diversions",   label: "Ship Diversions", icon: Waypoints },
