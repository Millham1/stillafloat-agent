// port-resolve.ts (was world-ports.ts on dev until 2026-09-24; main now generates world-ports.ts from the CruiseMapper scrape) — cruise ports beyond the tracker gazetteer, for itinerary resolution.
//
